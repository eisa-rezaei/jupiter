...
export const RECENT_WORKS_LIST = [
  {
    id: 1,
    img: Projcet1,
...
export const EXPERTISE_LIST = [
  {
    ...
    icon: <CgWebsite />,
    description:
      "  Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasidolore nisi optio ipsum rerum. Vel neque aut consequuntur voluptastemporibus. Tempora, quas aperiam?",
  },
  {
    id: 2,
    title: "Mobiles",
